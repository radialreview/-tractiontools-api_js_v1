...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TractionToolsApiV1.CreateIssue();
  });
  ...
  describe('CreateIssue', function() {
    it('should create an instance of CreateIssue', function() {
      // uncomment below and update the code to test CreateIssue
      //var instance = new TractionToolsApiV1.CreateIssue();
      //expect(instance).to.be.a(TractionToolsApiV1.CreateIssue);
    });
