...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TractionToolsApiV1.Milestone();
  });
  ...
  describe('Milestone', function() {
    it('should create an instance of Milestone', function() {
      ...
      //var instance = new TractionToolsApiV1.Milestone();
      //expect(instance).to.be.a(TractionToolsApiV1.Milestone);
    });
    ...
    it('should have the property rockId (base name: "RockId")', function() {
      // uncomment below and update the code to test the property rockId
      //var instance = new TractionToolsApiV1.Milestone();
      //expect(instance).to.be();
    });
