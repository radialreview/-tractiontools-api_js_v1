...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TractionToolsApiV1.PermissionDto();
  });
  ...
  describe('PermissionDto', function() {
    it('should create an instance of PermissionDto', function() {
      ...
      //var instance = new TractionToolsApiV1.PermissionDto();
      //expect(instance).to.be.a(TractionToolsApiV1.PermissionDto);
    });
