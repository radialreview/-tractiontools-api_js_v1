...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TractionToolsApiV1.CreateMilestone();
  });
  ...
  describe('CreateMilestone', function() {
    it('should create an instance of CreateMilestone', function() {
      // uncomment below and update the code to test CreateMilestone
      //var instance = new TractionToolsApiV1.CreateMilestone();
      //expect(instance).to.be.a(TractionToolsApiV1.CreateMilestone);
    });
