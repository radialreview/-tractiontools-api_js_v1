...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TractionToolsApiV1.SearchApi();
  });
  ...
  describe('SearchApi', function() {
    ...
    describe('searchSearchUser', function() {
      it('should call searchSearchUser successfully', function(done) {
        //uncomment below and update the code to test searchSearchUser
        //instance.searchSearchUser(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
