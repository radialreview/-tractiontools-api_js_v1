...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TractionToolsApiV1.Team = factory(root.TractionToolsApiV1.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ManagedBy')) {
        obj['ManagedBy'] = ApiClient.convertToType(data['ManagedBy'], 'Number');
      }
  ...
  /**
   * @member {Number} ManagedBy
   */
  exports.prototype['ManagedBy'] = undefined;
  /**
   * @member {module:model/Team.TeamTypeEnum} TeamType
   */
